...
class Application(Frame):
    ...
    def createResult(self,frm):
        ...
        self.saleButton.grid(column=8, row=9,
                             columnspan=2, rowspan=4, sticky=E+S)
    ...
    def createPentu(self,frm):
        ...
        self.saleButton.grid(column=7, row=15,
                             columnspan=2, rowspan=3, sticky=E+S)
    ...
    def salePrice(self):
        ...
        self._dxmlv_f = (1.0-self._hjcb_f/self._hjxsj_f)*100
    ...
    def calPentu(self):
        ...
        ##4 喷涂销售毛利率
        self._ptmlv_f = (1.0-self._ptcb_f/self._ptxsj_f)*100
